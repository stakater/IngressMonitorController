...
func (in *AliCloudConfig) DeepCopyInto(out *AliCloudConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AliCloudConfig.
func (in *AliCloudConfig) DeepCopy() *AliCloudConfig {
	if in == nil {
		return nil
	}
	out := new(AliCloudConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EndpointMonitorSpec) DeepCopyInto(out *EndpointMonitorSpec) {
	*out = *in
	...
	if in.AliCloudConfig != nil {
		in, out := &in.AliCloudConfig, &out.AliCloudConfig
		*out = new(AliCloudConfig)
		**out = **in
	}
}
