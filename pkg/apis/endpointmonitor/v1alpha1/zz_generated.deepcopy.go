...
func (in *EndpointMonitorSpec) DeepCopyInto(out *EndpointMonitorSpec) {
	*out = *in
	...
	if in.GCloudConfiguration != nil {
		in, out := &in.GCloudConfiguration, &out.GCloudConfiguration
		*out = new(GCloudConfiguration)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GCloudConfiguration) DeepCopyInto(out *GCloudConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GCloudConfiguration.
func (in *GCloudConfiguration) DeepCopy() *GCloudConfiguration {
	if in == nil {
		return nil
	}
	out := new(GCloudConfiguration)
